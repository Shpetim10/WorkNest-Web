    ...
    <div className="flex flex-col gap-6 -mx-2 lg:-mx-4">
      ...
      >
        ...
        <button
          ...
          className="relative z-10 flex items-center gap-2 px-5 py-2.5 bg-white text-blue-600 rounded-xl text-sm font-semibold hover:bg-blue-50 transition-colors"
        >
          <Plus size={16} />
          Create Announcement
        </button>
