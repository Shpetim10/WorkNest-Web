    ...
    <div className="space-y-3">
      ...
      <div>
        ...
        <input
          ...
          className={`w-full h-[40px] px-3 rounded-[10px] border font-mono text-[14px] bg-[#F9FAFB] placeholder:font-mono placeholder:text-[rgba(10,10,10,0.5)] transition-all focus:outline-none focus:ring-2 focus:ring-[#155DFC]/20 ${errors.cidrBlock
